...
public class TournamentWinner {
    ...
    public static void main(String[] args) {
        ...
        String[][] competitions = new String[][] {
                ...
                { "Python", "HTML" },
                { "Python", "C#" } };
        int[] results = new int[] { 1, 0, 0, 0 };

        TournamentWinner tournamentWinner = new TournamentWinner();
        System.out.println(tournamentWinner.winner(competitions, results));
