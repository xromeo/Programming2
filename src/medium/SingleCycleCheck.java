...
public class SingleCycleCheck {
    ...
    public static boolean singleCycleCheck(int[] array) {
        ...
        while (numElementsVisited < array.length) {
            if (numElementsVisited > 0 && currentIndex == START) {
                return false;
            }
            numElementsVisited++;
    ...
    public static void main(String[] args) {
        int[] array1 = {2, 3, 1, -4, -4, 2};//true
        System.out.println(singleCycleCheck(array1));
        int[] array2 = {1,-1,5,1,4};//false
        System.out.println(singleCycleCheck(array2));
                int[] array3 = {2,-1,1,2,2};//false
        System.out.println(singleCycleCheck(array3));
    }
}
